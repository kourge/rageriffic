...
(function ($) {
    ...
    var webcam = {
      ...
      swffile: "../../../public/jscam_canvas_only.swf",

      debug:      function () {},
      onCapture: function () {
        jQuery("#webcamcontainer").css("display, block");
        jQuery("#webcamcontainer").fadeOut("fast", function () {
          jQuery("webcamcontainer").css("opacity", 1);
        });
        webcam.save();
      },

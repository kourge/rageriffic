...
function Upload() {
  $.post("http://api.imgur.com/2/upload.json",
     {key: "e0c2bcb83dab53d4d21d7fc77ef3f8c2",
      image: "http://alltheragefaces.com/img/faces/png/" + current_image,
      title: current_image},
     function(data) {
      console.log(data.upload.image.title);
      links[data.upload.image.title] = data.upload.links.original;
     }, "json");
}
